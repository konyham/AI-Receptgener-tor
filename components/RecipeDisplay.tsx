...
interface RecipeDisplayProps {
  ...
  onFeedback: (recipeName: string, feedback: 'like' | 'dislike') => void;
}
  ...
  onFeedback,
    ...
    const handleAddSelectedToShoppingList = () => {
        ...
        if (itemsToAdd.length > 0) {
            ...
            setCheckedIngredients(new Set()); 
            showNotification(`${itemsToAdd.length} hozzávaló hozzáadva a listához.`, 'success');
        }
    };
        ...
        <div className="animate-fade-in space-y-6">
            ...
            <div className="p-4 bg-gray-100 rounded-lg">
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
                    ...
                    {isFromFavorites && <ActionButton onClick={() => setIsFavoriteStatusModalOpen(true)} label="Kedvencnek jelölés"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-red-500" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" /></svg><span className="text-xs font-semibold">Kedvencek</span></ActionButton>}
