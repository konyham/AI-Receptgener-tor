...
const DataManagementControls: React.FC<DataManagementControlsProps> = ({
  ...
  return (
    <div className="mb-6 p-4 bg-gray-100 border border-gray-200 rounded-lg">
      <h3 className="text-lg font-bold text-center text-gray-700 mb-4">{t('dataManagement.title')}</h3>
      ...
      <p className="text-xs text-center text-gray-500 mt-3">{t('dataManagement.tooltip')}</p>
    </div>
  );
};
