...
const ImportImageModal: React.FC<ImportImageModalProps> = ({ isOpen, onClose, onParse, isParsing, error }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="import-image-title" className="text-xl font-bold text-gray-800 mb-4">Recept Fotózása</h2>
        ...
        {isParsing ? (
          ...
          <>
            <p className="text-gray-600 mb-6">Készítsen egy új fotót a beolvasáshoz. A gombra kattintva a telefon kamerája fog elindulni.</p>
            ...
            <div className="space-y-4">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2H4zm10 4a3 3 0 11-6 0 3 3 0 016 0z" clipRule="evenodd" /></svg>
                    Recept Fotózása
                </button>
                ...
                <input
                  ...
                  ref={fileInputRef}
                  accept="image/*"
                  capture // This attribute forces the camera to open directly
