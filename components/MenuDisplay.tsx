  ...
  return (
    <div className="animate-fade-in space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
        <div>
          <h2 className="text-3xl font-bold text-primary-800 dark:text-primary-300">{menu.menuName}</h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 mt-1">{menu.menuDescription}</p>
        </div>
