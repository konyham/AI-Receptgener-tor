...
const CACHE_NAME = 'konyha-miki-cache-v1.69.0';
const urlsToCache = [
  '/',
  '/index.html',
  '/index.tsx',
  '/manifest.json?v=1.69.0',
  // CDNs from importmap
  ...
  // Icons from manifest
  'https://storage.googleapis.com/genai-assets/konyha-miki-icons-v2/icon-192.png?v=1.69.0',
  'https://storage.googleapis.com/genai-assets/konyha-miki-icons-v2/icon-512.png?v=1.69.0',
  'https://storage.googleapis.com/genai-assets/konyha-miki-icons-v2/apple-touch-icon.png?v=1.69.0'
];
